...
public class DialogCrudViewController<T extends EntityStatus<ID>, ID extends Serializable>
		extends ViewController<T, ID> {
	...
	public DialogCrudViewController() {
